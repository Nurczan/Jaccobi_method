...
class Mesh:
    ...
    def calculate(self, method : str, filename : str = "result",folder : str = "./meshes"):
        ...
        time_before = time()
        with open(f"{folder}/{filename}","w+",newline='') as res, open(f"{folder}/{filename}_errors","w+",newline='') as error_file:
